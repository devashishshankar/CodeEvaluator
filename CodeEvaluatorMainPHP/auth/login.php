...
<head>
		...
		<title>Code Checker | Sign In</title>
	...
	<body id="login">
		...
		<div id="login-wrapper" class="png_bg">
			...
			<div id="login-content">
				...
				<form name="login" method="post" action="login_auth.php" onsubmit="return check()">
                                                          <?php
                                                            if(isset($_GET['r']))
                                                            {
                                                          ?>
                                    <div class="notification information png_bg" id="notif_msg">
						<div>
							<?php
                                                        echo $_GET['r'];
                                                        ?>
                            ...
                            Don't Have an account? <a href="register.php">Register Now!</a> <br /> <br /> <br />
					<p>
						<label>Username</label>
						<input class="text-input" id="uentry" type="text" name="username" />
